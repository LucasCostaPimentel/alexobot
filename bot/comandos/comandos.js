export function comandosInfo(botInfo){
    ...
    const comandos = {
        ...
        diversao: {
            ...
            parometro: {
                descricao: '',
                guia: `Ex: *${prefixo}parometro* @membro - Mede o nível de Paraense do membro mencionado.\n\n`+
                `Ex: Responder com *${prefixo}parometro* - Mede o nível de Paraense do membro respondido.\n`,
                msgs: {
                    respostas : [' 0%\n\n - NÃO É Paraense ',
                    '🤪  20% \n\n - É UM POUCO Paraense ',
                    '🤪🤪  40%\n\n - É QUASE UM Paraense, TA NO CAMINHO',
                    '🤪🤪🤪  60%\n\n - Paraense BRABO, INFELIZMENTE ESTÁ EVOLUINDO',
                    '🤪🤪🤪🤪  80%\n\n - SUPER Paraense OUVIDOR CARIMBÓ',
                    '🤪🤪🤪🤪🤪  100%\n\n - O Paraense MASTER, DEFENSOR DA CASTANHA DO PARÁ'],
                    resposta: "🧩 *parometro* - {p1}"
                }
            },
            victometro: {
                descricao: '',
                guia: `Ex: *${prefixo}victometro* @membro - Mede o nível aprendido com o victor do membro mencionado.\n\n`+
                `Ex: Responder com *${prefixo}victometro* - Mede o nível aprendido com o victor do membro respondido.\n`,
                msgs: {
                    respostas : [' 0%\n\n - Não sabe quem é victor',
                    '\n🎸  20%\n\n - acha o victor um cara legal',
                    '\n🎸🎸  40%\n\n - Ja deu em cima de alguem no grupo',
                    '\n🎸🎸🎸 60%\n\n - Está chamando menina de meu amor',
                    '\n🎸🎸🎸🎸 80%\n\n - ALERTA!! Comprou o curto do victor de pegador',
                    '\n🎸🎸🎸🎸🎸 100%\n\n - PERIGO!!! está invadindo pv das meninas e chamando de meu amor.'],
                    apenas_um: "[❗] Erro: Apenas um membro por vez deve ser mencionado.",
                    resposta: "🧩 *Victometro* - {p1}"
                }
            },
            top: {
                descricao: '',
        ...
        grupo: {
            ...
            bv: {
                ...
                msgs: {
                    ...
                    "Faça um pix de 10,00 para o admin do grupo(Sujeito a Ban) *{p2}*\n\n"+
                    "{p3}"+
